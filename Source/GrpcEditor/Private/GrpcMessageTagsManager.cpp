...
void UGrpcMessageTagsManager::ConstructTagTree()
{
	...
	FTurboLinkGrpcModule* turboLinkModule = FModuleManager::GetModulePtr<FTurboLinkGrpcModule>("Grpc");
	if (turboLinkModule == nullptr)
	{
		turboLinkModule = &(FModuleManager::LoadModuleChecked<FTurboLinkGrpcModule>("Grpc"));
	}
	if (turboLinkModule)
	{
