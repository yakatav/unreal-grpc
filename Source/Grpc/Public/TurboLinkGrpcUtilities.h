...
UCLASS()
class GRPC_API UTurboLinkGrpcUtilities : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
UCLASS()
class GRPC_API UGrpcMessageToJsonFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
